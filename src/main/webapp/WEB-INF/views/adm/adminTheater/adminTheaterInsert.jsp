      ...
      <div class="row">
        <div class="col-4">
          <div id="list-example" class="list-group">
            <a class="list-group-item list-group-item-action"
              href="#list-item-1">Theater info</a> <a
              class="list-group-item list-group-item-action"
              href="#list-item-2">Screen info</a> <a
              class="list-group-item list-group-item-action"
              href="#list-item-3">Seat info</a> <a
              class="list-group-item list-group-item-action"
        ...
        <div class="col-8">
          <div data-spy="scroll" data-target="#list-example"
            data-offset="0" class="position-relative mt-2"
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-sm-8 col-md-8 col-lg-8"
                    ...
                    <form class="mt-3">
                      <div class="form-group">
                        <input type="text" class="form-control"
                          id="nametext" aria-describedby="name"
                          placeholder="Name">
                      </div>
                    </form>
                  </div>
                  <div class="col-sm-12 col-md-12 col-lg-12"
                    ...
                    <form class="mt-3">
                      <div class="form-group">
                        <input type="text" class="form-control"
                          id="nametext2" aria-describedby="name"
                    ...
                    <div class="form-check form-check-inline mt-2">
                      <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input"
                          ...
                          for="customControlValidation2">1개관</label>
                      </div>
                    </div>
                    <div class="form-check form-check-inline mt-2">
                      <div class="custom-control custom-radio">
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3"
                    ...
                    <form class="mt-2">
                      <div class="form-group">
                        <input type="text" class="form-control"
                          id="nametext1" placeholder="Total Seats"
                          disabled>
                      </div>
                    </form>
                  </div>
                ...
                <div class="col-lg-12 mb-3" style="text-align: right;">
                  <div class="btn-list">
                    <button onclick="go_save()" type="button" class="btn btn-success">
