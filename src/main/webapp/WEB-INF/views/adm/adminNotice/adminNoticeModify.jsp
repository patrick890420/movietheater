  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-7 align-self-center">
        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">お知らせ修整</h4><!-- 수정 -->
...
<!--           Table -->
<form name="admin" method="get" action="adminNoticeModifyPro.do" enctype="multipart/form-data" onsubmit="return check()">
  <input type="hidden" name="nt_cd" value="${nview.nt_cd }"><!-- 번호 받아오는 문장 -->
      ...
      <tr>
        ...
        <td>
          <select name="choice" aria-controls="zero_config" class="form-control form-control-sm">
            <option value="">お知らせ</option><!-- 공지 -->
          </select>
        </td>
      </tr>
      <tr>
        <th>題目</th><!-- 제목 -->
        <td><input class="form-control" type="text" name="title" value="${nview.title}"></td>
      </tr>
      <tr>
        <th class="adminwrite66">内容</th><!-- 내용 -->
        <td><textarea class="form-control" name="content" id="summernote" rows="8">${nview.content}</textarea></td>
      </tr>
    </tbody>
  </table>
